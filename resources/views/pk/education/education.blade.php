...
<html lang="en">
<head>
<title>Inspiring an Education Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
<!-- custom-theme -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Inspiring Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
...
<!-- //custom-theme -->
<link href="{{asset('/pk/edu1')}}/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="{{asset('/pk/edu1')}}/css/style.css" rel="stylesheet" type="text/css" media="all" />


<!-- font-awesome-icons -->
<link href="{{asset('/pk/edu1')}}/css/font-awesome.css" rel="stylesheet"> 
<!-- //font-awesome-icons -->
...
<div class="sub-agile">
				...
				<div>
					<p>
						<button id="trigger-overlay" type="button">
							<img src="{{asset('/pk/edu1')}}/images/menu.png" class="img-responsive" alt="menu">
		...
		<a href="index.html">
			<ul class="logo">
				<li><i class="glyphicon glyphicon-book" aria-hidden="true"></i></li>
				<li><h1>Inspiring</h1></li>
			</ul>
			</a>
				<div class="number">
					<p><a href="#contact" class="scroll"><i class="fa fa-envelope" aria-hidden="true"></i></a></p>
					<p>+013 244 5566</p>
				</div>
				...
				<section class="slider">
					<div class="flexslider">
						<ul class="slides">
							<li>
							<div class="w3l-info">
								<h2>Education is important to our life</h2>
										<div class="col-md-4">
											<div class="grid1">
											<i class="fa fa-graduation-cap" aria-hidden="true"></i>
											<p>Education is premise of progress & Life</p>
											</div>
										</div>
										<div class="col-md-4">
											<div class="grid1">
										...
										<div class="col-md-4">
											...
											<p>Education is passport to the future</p>
											</div>
										</div>
										<div class="clearfix"></div>
							</div>
...
<div class="copyright-agile">
	<p>© 2017 Inspiring. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p>
</div>
<!-- //copyright -->
