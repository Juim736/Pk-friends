		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
			  ...
			  @if(Sentinel::getUser()->user_type == '11' || Sentinel::getUser()->user_type == '1')
				...
				<li class="gn-trigger"></li>
				@endif
				<!-- //nav_agile_w3l -->
				<li class="second logo"><h1><a href="{{url('/pk-friends')}}"><i class="fa fa-graduation-cap" aria-hidden="true"></i>PK FR</a></h1></li>
									...
									<li class="dropdown profile_details_drop">
										...
										<ul class="dropdown-menu drp-mnu">
											...
											<li> 
													...
													<a href="javascript::void(0)" onclick="document.getElementById('signout_form').submit()"><i class="fa fa-sign-out"></i> Sign Out</a>
				...
				<li class="second top_bell_nav">
					<section class="">
						<a href="{{url('/supoort-pk')}}">Support PK</a>
					</section>
				</li>
