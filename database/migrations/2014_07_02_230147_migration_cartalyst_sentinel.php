...
class MigrationCartalystSentinel extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->enum('union', array('Pakundiya', 'Hosendi', 'Narandi', 'Patuyavannga', 'Chondipasha','Sukhiya','Janngaliya', 'Chorporadi','Egarosindur','Burudiya'));
            $table->enum('blood', array('A+', 'A-', 'B+', 'B-', 'O+','O-','AB+', 'AB-'));
            ...
            $table->string('image')->default('pk/images/pro-image.jpg');
